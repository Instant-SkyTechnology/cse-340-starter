...
/* 1. Insert a new account record (Tony Stark)
...
/* 5. INNER JOIN to select Sport inventory
...
/* 6. Update all image paths to include /vehicles
   Updates both inv_image and inv_thumbnail */
UPDATE public.inventory
SET
